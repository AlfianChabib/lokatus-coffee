    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g data-name="Layer 1" id="Layer_1">
          <rect className="cls-1" height="2040" width="2040" x="5" y="5"></rect>
        </g>
        <g data-name="Layer 3" id="Layer_3">
          <circle className="cls-2" cx="1025" cy="1025" r="613.7"></circle>
          <path
            className="cls-3"
          ...
          ></ellipse>
          <circle className="cls-1" cx="803.6" cy="857.7" r="16.6"></circle>
          <ellipse
            className="cls-4"
            cx="1276.1"
            cy="896.3"
          ...
          ></ellipse>
          <circle className="cls-1" cx="1296.4" cy="857.7" r="16.6"></circle>
          <path
            className="cls-5"
